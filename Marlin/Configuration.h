...
#define STRING_CONFIG_H_AUTHOR "(XcLxAd)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SapphirePro_dev"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.9, 80, 1600, 408}
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -41, -0.7 }
